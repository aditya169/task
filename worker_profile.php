<?php
//============================================================+
// File name   : worker_profile.php
//
// Description : This file displays task worker's profile
//
...
<table class="main-table">
	...
	<tr><td><strong>Reviews</strong></td><td><?php echo"<a href=reviews.php?wi={$row['worker_id']} title='view'>View</a></td>";	
?></td></tr>
</table>
</td></tr>
</table>
...
<form id="contactForm" action="worker_profile2.php" method="post">
  <h2>Edit Profile</h2>
	<ul>
		<li>
